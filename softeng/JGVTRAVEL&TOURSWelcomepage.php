...
<body>               
    ...
    <button type ="button" style="padding-left:90px;padding-top:2px;height:20px;color: white;" class="btn btn-link" data-toggle="modal" data-target="#myservices" >Services</button></a>
    ...
    <button type ="button" style="padding-left:1px;padding-top:2px;height:20px;color: white;" class="btn btn-link" data-toggle="modal" data-target="#mypromos" > Promos </button></a>
     <button type ="button" style="padding-left:80px;padding-top:2px;height:20px;color: white;" class="btn btn-link" data-toggle="modal" data-target="#myregister" > Register </button></a>
      <button type ="button" style="padding-left:1px;padding-top:2px;height:20px;color: white;" class="btn btn-link" data-toggle="modal" data-target="#mylogin">Log-in </button></a>
        ...
        <div class="modal-header" style="background-color:#99b3ff;">
          ...
          <div class="modal-body">
                <h6 style="color:#0000FF">Name</h6>
                <input class="form-booking-tour" autofocus="autofocus" name="name" type="text"  required="required";><br>
                 <h6 style="color:#0000FF">Age</h6>
                <input class="form-booking-tour" autofocus="autofocus" name="age" type="text"  required="required";><br>
                <h6 style="color:#0000FF">Address</h6>
                <input class="form-booking-tour" autofocus="autofocus" name="address" type="text"  required="required";><br>
                 <h6 style="color:#0000FF">Contact No:</h6>
                <input class="form-booking-tour" autofocus="autofocus" name="Contact" type="text"  required="required";><br>
                <h6 style="color:#0000FF">Select Destinations:</h6>
                <input type="radio" name="Destinations" value="tagaytay">Tagaytay
                <input type="radio" name="Destinations" value="Manila">Manila
                 <input type="radio" name="Destinations" value="Cebu">Cebu City 
                <input type="radio" name="Destinations" value="Baguio">Baguio CIty
        ...
        <div class="modal-header" style="background-color:#99b3ff;">
          ...
          <img src="pictures/baguio.jpg" style="width: 150px;height: 80px;padding-top:10px;margin-top: -10px;">
          ...
          <img src="pictures/manila.jpg" style="width: 150px;height:80px;margin-top:20px;">
          ...
          <img src="pictures/baguio.jpg" style="width: 150px;height:80px;">
          ...
          <img src="pictures/palawan.jpg" style="width: 150px;height: 80px;margin-top:20px;">
          ...
          <img src="pictures/bohol.jpg" style="width: 150px;height: 80px;">
          <button type ="button" style="padding-left:1px;padding-top:2px;height:20px; pull-right:500px;" class="btn btn-link" data-toggle="modal" data-target="#btnbohol">Bohol </button></a>
           <img src="pictures/davao.jpg" style="width: 150px;height: 80px; margin-top: 20px;">
  ...
  <!-- Left and right controls -->
    ...
    <img src="pictures/malaysiaflag.png" style="height:20px;width:30px;">
    <img src="pictures/japanflag.png" style="height:20px;width:30px;">
    <img src="pictures/dubaiflag.png" style="height:20px;width:30px;">
    <img src="pictures/usaflag.png" style="height:20px;width:30px;">
    <img src="pictures/londonflag.png" style="height:20px;width:30px;">
    <img src="pictures/russiaflag.png" style="height:20px;width:30px;">
    <img src="pictures/vietnamflag.png" style="height:20px;width:30px;">
    <p5 style="color:white;">JGV Travel and Tours <img src="pictures
    /chinaflag.png" style="height:20px;width:30px;"> <img src="pictures/philippinesflag.png" style="height:20px;width:30px;"> <img src="pictures/koreaflag.png" style="height:20px;width:30px;">
    <img src="pictures/qatarflag.png" style="height:20px;width:30px;"> <img src="pictures/canadaflag.png" style="height:20px;width:30px;">
    <img src="pictures/ukflag.png" style="height:20px;width:30px;"> <img src="pictures/kuwaitflag.png" style="height:20px;width:30px;"> <img src="pictures/indiaflag.png" style="height:20px;width:30px;"> <img src="pictures/franceflag.png" style="height:20px;width:30px;"> </p5><br><br><br><br>
    </div>
   </div>
   <div>
 </div>
